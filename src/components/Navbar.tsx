...
export default function Navbar({ transparent = false }: NavbarProps) {
  ...
  return (
    <header className={`${base} flex items-center justify-between px-8 py-4`}>
      ...
      {!isLoggedIn ? (
        <div className="flex items-center gap-3">
          ...
          <Link to="/registro" className="bg-violet-600 hover:bg-violet-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors">
            Registrarse
          </Link>
        </div>
      ) : (
